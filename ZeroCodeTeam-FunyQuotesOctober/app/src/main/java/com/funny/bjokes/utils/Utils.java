...
public class Utils {
	...
	public static String convertToMarker(String value) {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		try {
			Date date = sdf.parse(value);

			SimpleDateFormat sdf_r = new SimpleDateFormat("h:mm a, d/M/yy");
			return sdf_r.format(date);
		}catch (Exception e){}
...
//			return timestamp.toString();
	...
	public static float checkNull(Object string, float def) {
